class PublishingHousesController < ApplicationController
  ...
  # GET /publishing_houses or /publishing_houses.json
  def index
    @publishing_houses = PublishingHouse.all
  end

  # GET /publishing_houses/1 or /publishing_houses/1.json
  def show
  end
  ...
  # POST /publishing_houses or /publishing_houses.json
  def create
  ...
  # PATCH/PUT /publishing_houses/1 or /publishing_houses/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /publishing_houses/1 or /publishing_houses/1.json
  def destroy
    @publishing_house.destroy!

    respond_to do |format|
      format.html { redirect_to publishing_houses_path, status: :see_other, notice: "Publishing house was successfully destroyed." }
  ...
  private
    ...
    def publishing_house_params
      params.require(:publishing_house).permit(:name, :description, :user_id)
    end
end
