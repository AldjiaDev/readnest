...
ActiveRecord::Schema[7.2].define(version: 2025_10_21_114312) do
  ...
  create_table "chronicles", force: :cascade do |t|
    ...
    t.string "caption"
    t.string "slug"
    t.index ["slug"], name: "index_chronicles_on_slug", unique: true
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "reported"
    t.index ["chronicle_id"], name: "index_comments_on_chronicle_id"
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chronicle_id"], name: "index_favorites_on_chronicle_id"
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chronicle_id"], name: "index_likes_on_chronicle_id"
  ...
  create_table "publishing_houses", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "slug"
    t.index ["slug"], name: "index_publishing_houses_on_slug", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "slug"
    t.boolean "is_publishing_house", default: false
    t.boolean "is_bookshop"
  ...
  add_foreign_key "favorites", "chronicles"
  add_foreign_key "favorites", "users"
  add_foreign_key "follows", "users", column: "follower_id"
  add_foreign_key "likes", "chronicles"
